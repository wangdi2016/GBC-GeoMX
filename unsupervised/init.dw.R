...
parent_dir <- "/Users/wangdi/work/DWX/geomx/jill/2025-08-12/GBC"
knitr::opts_knit$set(root.dir = parent_dir)
knitr::opts_chunk$set(warning=FALSE, message=FALSE, echo=FALSE)

## add library path
print(.libPaths())
#.libPaths(c("/Library/Frameworks/R.framework/Versions/4.3-arm64/Resources/library/",
...
#date_tag <- "20241001"
date_tag <- "20250904"
outdir <- paste0("output_GBC_", date_tag)
